...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: 'description',
      content: 'Clear, transparent pricing for business restructuring services.',
    },
  ];
};
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Clear scope boundaries and outcomes. We recommend starting with the Diagnostic to
          ...
          {tiers.map((tier, index) => (
            <Card key={index} className={index === 0 ? 'border-primary border-2' : ''}>
              <CardHeader>
                ...
                <div className="text-2xl font-bold text-primary mt-2">{tier.investment}</div>
              </CardHeader>
              <CardContent>
                <p className="mb-6 text-gray-600 dark:text-gray-400">{tier.description}</p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Every engagement is scoped based on your specific needs. Book a call to discuss your
            situation and get a custom proposal.
          </p>

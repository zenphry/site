          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="bg-gray-50/75 dark:bg-gray-800/75 backdrop-blur-sm p-6 rounded-lg">
              <p className="text-gray-700 dark:text-gray-300">
                Operational Restructuring focuses on fixing how work flows
                through the business. Zenphry restructures operations so work
                moves predictably, ownership is clear, and results are
                repeatable — not because teams work harder, but because the
                structure supports consistent execution.
              </p>
            </div>
          </div>

      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="space-y-4">
            {[
              { step: 'Week 1', activity: 'Data gathering, interviews, workflow observation' },
              { step: 'Week 2', activity: 'Analysis and root cause identification' },
              { step: 'Week 3', activity: 'Report delivery and roadmap presentation' },
            ].map((item, index) => (
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <p className="mt-4 text-sm text-gray-500 dark:text-gray-500">
            The Diagnostic is designed to identify issues. Implementation requires a separate
            engagement (Foundation, Growth, or Enterprise tier).
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                We will request org charts, process documentation (if available), financial KPIs,
                and access to leadership for interviews. Most data gathering happens through
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                Yes. The Diagnostic can be conducted entirely remotely via video calls and
                asynchronous data gathering. On-site work is available if preferred.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-3">
              <AccordionTrigger>What happens after the Diagnostic?</AccordionTrigger>
              <AccordionContent>
                You receive a comprehensive report with prioritized recommendations and a 30-90 day
                roadmap. You can choose to implement internally, engage Zenphry for implementation
                support, or take no action.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-4">
              <AccordionTrigger>Is the Diagnostic required before other services?</AccordionTrigger>
              <AccordionContent>
                Recommended but not required. The Diagnostic ensures we focus on the right problems
                before committing to implementation. Some clients already know what needs to change
                and start directly with Foundation, Growth, or Enterprise engagements.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
        ...
        <div className="max-w-2xl mx-auto text-center bg-primary text-primary-foreground p-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">Request the Restructuring Diagnostic</h2>
          <p className="mb-6">
            Identify what needs to change before committing to full restructuring.
          </p>

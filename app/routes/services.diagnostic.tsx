          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Yes. The Diagnostic can be conducted entirely remotely via
                  video calls and asynchronous data gathering. On-site work is
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  ...
                  implement internally, engage Zenphry for implementation
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  Recommended but not required. The Diagnostic ensures we focus
                  on the right problems before committing to implementation.
                  Some clients already know what needs to change and start
                  directly with Foundation, Growth, or Enterprise engagements.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>

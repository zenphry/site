          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="bg-gray-50/75 dark:bg-gray-800/75 backdrop-blur-sm p-6 rounded-lg">
              <p className="text-gray-700 dark:text-gray-300">
                Organizational and Team Restructuring focuses on realigning
                people, roles, and decision-making structures so the
                organization can execute efficiently and scale without friction.
                This is practical restructuring built around how work actually
                gets done — not headcount reduction or theoretical org design.
              </p>
            </div>
          </div>

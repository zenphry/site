        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-600 dark:text-gray-300">
              Zenphry is a business restructuring and transformation firm that
              helps companies fix broken operations, realign teams, and build
      ...
      <section className="py-20 bg-primary/90 backdrop-blur-sm text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Book a discovery call or request the Restructuring Diagnostic to
